...
function displayClassList(classes) {
    ...
    headerRow.innerHTML = '<th scope="col">Nom de la classe</th><th scope="col">Niveau</th><th scope="col">Actions</th>';
...
async function displayStudentList(students) {
    ...
    // Création de l'en-tête du tableau
    var headerRow = document.createElement('tr');
    headerRow.innerHTML = '<th scope="col">Nom</th><th scope="col">Prénom</th><th scope="col">Email</th><th scope="col">Téléphone</th><th scope="col">Adresse</th><th scope="col">Code Postal</th><th scope="col">Ville</th><th scope="col">Classe</th><th scope="col">Actions</th>';
